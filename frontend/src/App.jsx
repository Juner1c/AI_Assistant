    ...
    <div className="dashboard-layout-wrapper">
      ...
      <div className="dashboard-container">
        ...
        <main className="main-panel">
          ...
          {/* FLOATING FIXED BOTTOM INPUT CONTAINER (LIKE CHATGPT SCREENSHOT) */}
          <div className="fixed-bottom-input-container">
            <div className="chatgpt-disclaimer-text">
              mai-assistant can make mistakes. Verify important safety info.
            </div>
